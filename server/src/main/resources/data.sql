...
insert into user (id,username, displayname, password) values (1, 'admin', '$2a$10$r7NbBQhJO0ajUL377HQV2.vpm/aYsr70x.aBAfLng0GRP3cG0kM5m', 'admin');
insert into user (id,username, displayname, password) values (2, 'user', '$2a$10$beyIHcn39TB0Z2/7ylIC6eto4zsSkdh1lgpnqz6EM9GkKyEt7SwSK', 'user');
insert into user (id,username, displayname, password) values (3, 'user1', '$2a$10$beyIHcn39TB0Z2/7ylIC6eto4zsSkdh1lgpnqz6EM9GkKyEt7SwSK', 'password');
insert into user (id,username, displayname, password) values (4, 'user2', '$2a$10$beyIHcn39TB0Z2/7ylIC6eto4zsSkdh1lgpnqz6EM9GkKyEt7SwSK', 'password');
